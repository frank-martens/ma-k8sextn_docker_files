****************************************************************************
   ...
   Please consult the documentation online for up-to-date information
       ...
       https://docs.appdynamics.com/display/4.5.7/Server+Monitoring
...
To enable HTTPS between the agent and the controller, consult the online documentation
        ...
        https://docs.appdynamics.com/display/4.5.7/Enable+SSL+for+Standalone+Machine+Agent
...
More issues are discussed online here:
        ...
        https://docs.appdynamics.com/display/4.5.7/Standalone+Machine+Agent+FAQ
